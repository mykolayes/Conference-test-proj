...
public class SetAnnouncementServlet extends HttpServlet { //_skeleton
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Iterable<Conference> iterable = ofy().load().type(Conference.class).filter("seatsAvailable <", 6).list();
